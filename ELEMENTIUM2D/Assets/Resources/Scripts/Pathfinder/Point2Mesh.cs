...
public class Point2Mesh : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Vertex2[] vertices2D = new Vertex2[children.Length - 1];
        int x = 0;
        foreach (Transform t in children)
        {
            ...
            {
                //Debug.Log(t.name);
                vertices2D[x] = new Vertex2(t.transform.localPosition.x, t.transform.localPosition.z);
                x++;
            }
        }
        ...
        {
            vertices[i] = new Vector3((float)vertices2D[i].x, (float)transform.localPosition.y, (float)vertices2D[i].y);
            indices[i] = i;
        }
       ...
       // VoronoiMesh<Vertex2, Cell2, VoronoiEdge<Vertex2, Cell2>> voronoiMesh;
        //voronoiMesh = VoronoiMesh.Create<Vertex2, Cell2>(vertices2D);
